...
interface VotingEscrow:
    def user_point_epoch(addr: address) -> uint256: view # last epoch user interacted with contract
    def epoch() -> uint256: view # last global interaction
    # user_point_history: public(HashMap[address, Point[1000000000]])  # user -> Point[user_epoch]
    def user_point_history(addr: address, loc: uint256) -> Point: view #
    def point_history(loc: uint256) -> Point: view
    def checkpoint(): nonpayable # accounting
